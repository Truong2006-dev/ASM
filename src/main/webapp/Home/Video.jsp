...
<body class="bg-light">
    ...
    <div class="container mt-4">
        <div class="row justify-content-center">
            <div class="col-lg-10">
                ...
                <div class="ratio ratio-16x9 mb-3 shadow-sm" style="background: #000; border-radius: 8px; overflow: hidden;">
                            ...
                            <form method="post">
                                ...
                                <c:choose>
                                    <c:when test="${not empty favorite}">
                                        <button formaction="${pageContext.request.contextPath}/dislike?id=${video.id}&path=video"
                                    ...
                                    <c:otherwise>
                                        <button formaction="${pageContext.request.contextPath}/like?id=${video.id}&path=video"
                                ...
                                <a href="${pageContext.request.contextPath}/crud/index" class="btn btn-secondary ms-2">
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            var rawId = document.getElementById("rawVideoId").value.trim();
