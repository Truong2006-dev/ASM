    ...
    <div class="container mt-4">
        <div class="row">
            <c:forEach var="v" items="${videos}">
                <c:if test="${v.active == true}">
                    <div class="col-md-4 mb-4">
                        <div class="card h-100 shadow-sm">
                            
                            <a href="${pageContext.request.contextPath}/crud/detail?id=${v.id}" class="position-relative text-decoration-none">
                            ...
                            <div class="card-body">
                                <h5 class="card-title text-truncate">
                                    <a href="${pageContext.request.contextPath}/crud/detail?id=${v.id}" class="text-decoration-none text-dark">
                                        ${v.titile}
                                    </a>
                                </h5>
                            </div>
