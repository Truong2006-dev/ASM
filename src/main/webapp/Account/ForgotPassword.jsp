...
<head>
    ...
    <style>
        ...
        .card-header-auth {
            background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); /* Giữ màu đồng bộ với trang trước */
            padding: 30px 20px;
            color: white;
            text-align: center;
        }
            ...
            <div class="col-md-5 col-lg-4">
                ...
                <div class="card card-auth shadow-lg">
                    ...
                    <div class="card-header-auth">
                        ...
                        <p class="small text-white-50 mb-0">Nhập email để lấy lại mật khẩu</p>
                    </div>
